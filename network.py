...
# List[int] describes the structure of its layers for example [2, 3, 1] 
# describes a network with 2 neurons in the input layer, three in the
...
class Network:
    ...
    # Real Python article on Python's reduce() function:
    ...
    # Could use this function to generate errors
